...
func _setup_random_room_weights() -> void:
	...
	random_room_type_weights[Room.Type.SHOP] = MONSTER_ROOM_WEIGHT + SHOP_ROOM_WEIGHT+SHOP_ROOM_WEIGHT
...
func _setup_room_types() -> void:
	...
	# 9 th floor is always a treasure room
...
func _set_room_randomly(room_to_set: Room) -> void:
	...
	while campfire_below_4 or consecutive_campfires or consecutive_shops or campfire_on_13:
	...
	if type_candidate == Room.Type.MONSTER:
		...
		room_to_set.battle_stats = battle_stats_pool.get_random_battle_for_tier(tier)
